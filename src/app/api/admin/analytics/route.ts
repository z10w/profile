 ...
 * - Revenue: Sum of all PURCHASE credit transactions
 * - Average Scores: Avg score per Exam Type
 * - AI Cost: Sum of all aiCost from ExamHistory
 * - Visuals: Use recharts to display Line charts (Revenue) and Bar charts (Scores)
 */
